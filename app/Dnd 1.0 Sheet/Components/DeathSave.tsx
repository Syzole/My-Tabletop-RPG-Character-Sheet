...
function DeathSave(props: { classes?: string; label: React.ReactNode; defaultValue?: number; onChange: (arg0: any, arg1: number | null) => void; name: any }) {
