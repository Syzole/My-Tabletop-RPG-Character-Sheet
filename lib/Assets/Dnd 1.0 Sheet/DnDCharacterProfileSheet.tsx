								...
								<div className="row pl-3 pr-3">
									<div className="col-md-4 col-6 pl-0 pr-0">
										<input
											...
											onChange={ (e) => this.updateCharacter("age", e.target.value) }
										/>
										<label>Age</label>
									</div>
									<div className="col-md-4 col-6 pl-0 pr-0">
										<input
											...
											onChange={ (e) => this.updateCharacter("height", e.target.value) }
										/>
										<label>Height</label>
									</div>
									<div className="col-md-4 col-6 pl-0 pr-0">
										<input
											...
											onChange={ (e) => this.updateCharacter("weight", e.target.value) }
										/>
										<label>Weight</label>
									</div>
								</div>
								<div className="row pl-3 pr-3">
									<div className="col-md-4 col-6 pl-0 pr-0">
										<input
											...
											onChange={ (e) => this.updateCharacter("eyes", e.target.value) }
										/>
										<label>Eyes</label>
									</div>
									<div className="col-md-4 col-6 pl-0 pr-0">
										<input
											...
											onChange={ (e) => this.updateCharacter("skin", e.target.value) }
										/>
										<label>Skin</label>
									</div>
									<div className="col-md-4 col-6 pl-0 pr-0">
										<input
											...
											onChange={ (e) => this.updateCharacter("hair", e.target.value) }
										/>
										<label>Hair</label>
									</div>
								</div>
						...
						<div className="col-md-4">
							...
							<div className="d-and-d-box mt-3">
								<textarea
									...
									onChange={ (e) => this.updateCharacter("backstory", e.target.value) }
									rows={ 26 }
								/>
								<label
									className="d-and-d-title"
								...
								<div className="row">
									<div className="col-md-6 border-right">
										...
										>
											...
											<input
												...
												onChange={ (e) => this.updateCharacter("factionRank", e.target.value) }
											/>
										</div>
										...
										<textarea
											...
											onChange={ (e) => this.updateCharacter("allies", e.target.value) }
											rows={ 16 }
										/>
									</div>
									<div className="col-md-6">
										...
										<textarea
											...
											onChange={ (e) => this.updateCharacter("allies2", e.target.value) }
											rows={ 3 }
										/>
									</div>
								</div>
								...
								<div className="row">
									<div className="col-md-6 border-right">
										<textarea
											...
											onChange={ (e) => this.updateCharacter("additionalFeatures", e.target.value) }
											rows={ 13 }
										/>
									</div>
									<div className="col-md-6">
										<textarea
											...
											onChange={ (e) => this.updateCharacter("additionalFeatures2", e.target.value) }
											rows={ 13 }
										/>
									</div>
								</div>
								...
								<div className="row">
									<div className="col-md-6 border-right">
										...
										<textarea
											...
											onChange={ (e) => this.updateCharacter("treasure", e.target.value) }
											rows={ 8 }
										/>
									</div>
									<div className="col-md-6">
										<textarea
											...
											onChange={ (e) => this.updateCharacter("treasure2", e.target.value) }
											rows={ 10 }
										/>
									</div>
								</div>
